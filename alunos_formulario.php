...
<body>
    ...
    <div class="container">
        ...
        <form class="row g-3" action="alunos_insere.php" method="post">
            ...
            <div class="col-md-12">
                <label for="nome" class="form-label">Atuação</label>
            ...
            <div class="col-md-12">
                <label for="nome" class="form-label">Formação</label>
                <input type="text" class="form-control" id="formacao" name="mestre_em">
            </div>
            <div class="col-12">
